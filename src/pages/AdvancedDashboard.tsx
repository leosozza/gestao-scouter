 ...
 * Professional dashboard system that surpasses Looker Studio and PowerBI
 */
...
import { Plus, Save, Download, Upload, LayoutDashboard, Settings, Trash2, Copy, RefreshCw } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Sistema profissional de dashboards com drag & drop e personalização completa
            </p>
          </div>
